...
import fr.ddelivery.exceptions.ExternalPartnerException;
...
public class CarrierAPI {
	...
	public boolean postBill(String value) throws ExternalPartnerException {
		// Building bill request
		JSONObject request = new JSONObject().put("Amount", value);

...
public class ObjectFactory {
    ...
    private final static QName _GetNextDeliveryResponse_QNAME = new QName("http://localhost:8080", "getNextDeliveryResponse");
    private final static QName _GetParcelResponse_QNAME = new QName("http://localhost:8080", "getParcelResponse");
    private final static QName _GetNextDelivery_QNAME = new QName("http://localhost:8080", "getNextDelivery");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8080", name = "getNextDeliveryResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8080", name = "getNextDelivery")

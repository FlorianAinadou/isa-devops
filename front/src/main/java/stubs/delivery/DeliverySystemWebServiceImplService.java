 ...
 * 2020-03-28T16:45:47.814+01:00
 * Generated source version: 2.7.9
 * 
 */
@WebServiceClient(name = "DeliverySystemWebServiceImplService", 
                  wsdlLocation = "file:/home/maeldelaby/Cours/2020/ISA_DEVOPS/projet-isa-devops-20-team-j-20/front/src/main/resources/DeliverySystemWebServiceImpl.wsdl",
...
public class DeliverySystemWebServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/maeldelaby/Cours/2020/ISA_DEVOPS/projet-isa-devops-20-team-j-20/front/src/main/resources/DeliverySystemWebServiceImpl.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DeliverySystemWebServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/maeldelaby/Cours/2020/ISA_DEVOPS/projet-isa-devops-20-team-j-20/front/src/main/resources/DeliverySystemWebServiceImpl.wsdl");
        }
        WSDL_LOCATION = url;
    }

...
@WebServiceClient(name = "DeliverySystemWebServiceImplService", 
                  wsdlLocation = "file:/Users/virgilefantauzzi/Desktop/dossier%20sans%20titre%204/projet-isa-devops-20-team-j-20/front/src/main/resources/DeliverySystemWebServiceImpl.wsdl",
...
public class DeliverySystemWebServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/virgilefantauzzi/Desktop/dossier%20sans%20titre%204/projet-isa-devops-20-team-j-20/front/src/main/resources/DeliverySystemWebServiceImpl.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DeliverySystemWebServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/virgilefantauzzi/Desktop/dossier%20sans%20titre%204/projet-isa-devops-20-team-j-20/front/src/main/resources/DeliverySystemWebServiceImpl.wsdl");
        }
        WSDL_LOCATION = url;
    }
